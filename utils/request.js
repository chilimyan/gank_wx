...
const REQUEST_CACHE = []
const API_BASE_URL = 'http://gank.io'
 ...
 * cache: 缓存时长(单位: 秒)
 */
function FetchRequest(url, data, method = 'GET', cache = 0, header = { 'content-type': 'application/x-www-form-urlencoded'}) {
